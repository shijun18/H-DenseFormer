    ...
    def __init__(
        ...
        if positional_encoding_type == "learned":
            ...
            self.position_encoding = FixedPositionalEncoding(
                self.embedding_dim,self.num_patches
            )
        ...
        self.Unet = Unet(in_channels=self.num_channels, base_channels=16, num_classes=self.num_classes)
...
def TransBTS(n_channels=2, num_classes=2,img_dim=144,_conv_repr=True, _pe_type="learned"):
